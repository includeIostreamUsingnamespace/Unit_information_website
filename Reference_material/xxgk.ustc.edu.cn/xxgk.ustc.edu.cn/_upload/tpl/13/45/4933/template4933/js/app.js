...
SDAPP.prototype.plugin = function() {
    ...
    if (this.O['menu']) {
        ...
        if (/aside/.test(this.O.menu['type'])) {
            ...
            this.J(".navi-aside-toggle").addClass('navi-aside-toggle-show').on("click", function() {
                ...
                _this.J("body").addClass('navi-aside-page').css({
                        width: _this.client().width,
                        height: _this.client().height
                    })
                    .stop().animate({
                        marginLeft: 216
                    }, 250);
                _this.J(".aside-inner", $aside).addClass('aside-inner-show').stop().animate({
                    left: 0
                }, 250);
            });
            ...
            this.J(".navi-aside-mask").on("click", function(event) {
                ...
                _this.J("body").removeClass('navi-aside-page').stop().animate({
                    marginLeft: 0
                }, 250, function() {
                ...
                _this.J(".aside-inner", $aside).removeClass('aside-inner-show').stop().animate({
                    left: -216
                }, 250);
            });
            /*增加*/
    ...
    if (this.client().width < 768) {
        ...
        this.J("#gotop").on("click", function() {
            _this.J("body,html").stop().animate({
                scrollTop: 0
            }, 500);
        });
        this.J("#gobot").on("click", function() {
            _this.J("body,html").stop().animate({
                scrollTop: _this.J(document).height()
            }, 500);
        });
